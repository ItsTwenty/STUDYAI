  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-surface-900 p-12 flex-col justify-between relative overflow-hidden">
        <img src="/auth_bg.jpg" alt="StudyAI Background" className="absolute inset-0 w-full h-full object-cover" />
        ...
        <div className="absolute inset-0 opacity-20">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-80 h-80 border border-white/15 rounded-full" />
        </div>
        ...
        <div className="relative space-y-6">
          <h2 className="text-4xl font-bold text-white leading-tight">
            Turn any document into<br />a learning experience
          </h2>
          <p className="text-white/70 text-lg max-w-md">
            AI-powered summaries, flashcards, and quizzes generated from your study materials.
          </p>
          <div className="flex items-center gap-4 text-white/60 text-sm">
            <div className="flex -space-x-2">
              {['SC', 'MJ', 'PP', 'AK'].map((initials, i) => (
                <div key={i} className="w-8 h-8 rounded-full bg-white/20 border-2 border-brand-700 flex items-center justify-center text-white text-xs font-medium">
                  {initials}
                </div>
              ))}
            </div>
        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <button type="button" className="text-sm text-brand-600 hover:text-brand-700 font-medium cursor-pointer">
                Forgot password?
              </button>
            </div>
          ...
          <div className="mt-6 grid grid-cols-2 gap-3">
            <Button variant="outline" size="md" onClick={() => toast('Google OAuth requires Supabase setup')}>
            ...
            <Button variant="outline" size="md" onClick={() => toast('GitHub OAuth requires Supabase setup')}>
