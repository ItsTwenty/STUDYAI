    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-surface-900 p-12 flex-col justify-between relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-20">
          ...
          <div className="absolute bottom-40 left-10 w-64 h-64 border border-white/10 rounded-2xl -rotate-6" />
          <div className="absolute top-1/3 left-1/3 w-40 h-40 border border-white/15 rounded-2xl rotate-45" />
        </div>
        ...
        <div className="relative space-y-6">
          <h2 className="text-4xl font-bold text-white leading-tight">
            Start your journey<br />to smarter studying
          </h2>
          <p className="text-white/70 text-lg max-w-md">
            Create your free account and experience the future of learning.
          </p>
          <div className="space-y-4">
            {['Upload unlimited PDFs', 'AI-powered summaries', 'Smart flashcards & quizzes'].map((feature) => (
      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-12 bg-white">
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            ...
            <p className="text-surface-500">Start studying smarter in minutes</p>
          </div>
